...
<head>
  ...
  <style>
    body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding: 20px; line-height: 1.6; }
    .card { border: 2px solid #8B0000; padding: 20px; max-width: 420px; border-radius: 8px; background: #FFF8DC; }
    h2 { color: #8B0000; text-align: center; margin-top: 0; margin-bottom: 4px; }
    .sub { text-align: center; font-size: 13px; color: #555; border-bottom: 1px solid #8B0000; padding-bottom: 8px; margin-bottom: 12px; }
    .row { display: flex; justify-content: space-between; margin-bottom: 8px; border-bottom: 1px dashed #ccc; padding-bottom: 4px; }
    .bold { font-weight: bold; }
    .amount-box { border-top: 2px solid #8B0000; border-bottom: 2px solid #8B0000; padding: 10px 0; margin: 12px 0; text-align: center; }
    .amount-val { font-size: 24px; font-weight: bold; color: #8B0000; }
  </style>
</head>
<body>
  <div class="card">
    ...
    <div class="row"><span class="bold">அனுப்புபவர் (Sender):</span> <span>${payoutData.sender || payoutData.name || ''}</span></div>
    <div class="row"><span class="bold">பெறுபவர் (Receiver):</span> <span>${payoutData.receiver || ''}</span></div>
    <div class="row"><span class="bold">காரணம்:</span> <span>${payoutData.reason || ''}</span></div>
    <div class="amount-box">
      <div style="font-size: 14px; font-weight: bold; color: #8B0000;">செலவுத் தொகை</div>
      <div class="amount-val">₹${payoutData.amount || 0}</div>
    </div>
  </div>
</body>
</html>`;
